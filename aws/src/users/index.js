    ...
    try {
        ...
        switch (event.httpMethod) {
            ...
            case "GET":
                ...
                if (event.pathParameters != null) { // Burada pathParameters nesnesinin null olup olmadığını kontrol ediyoruz.
...
const getUser = async (userId) => { // GET user/{id}
    ...
    try { // Burada try-catch bloğu kullanıyoruz.

        const params = { // Burada params nesnesini oluşturuyoruz.
    ...
    } catch (e) { // Burada catch bloğunu yazıyoruz.
...
const createUser = async (event) => { // POST user
    ...
    try { // Burada try-catch bloğu kullanıyoruz.
        ...
        const params = { // Burada params nesnesini oluşturuyoruz.
            ...
            Item: marshall({ // Burada Item nesnesini oluşturuyoruz.
...
const deleteUser = async (userId) => { // DELETE user/{id}
...
// Path: src\users\ddbClient.js

// Compare this snippet from src\users\index.js:
...
// // Export the service client object.

// export { ddbClient };

// with this snippet from src\users\ddbClient.js:
